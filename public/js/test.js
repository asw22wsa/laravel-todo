...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    callApiData: function callApiData() {
      var _this = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                axios__WEBPACK_IMPORTED_MODULE_1___default().get("/api/v1/todos/search", {
                  params: {
                    page: _this.page,
                    query: _this.search
                  }
                }).then(function (res) {
                  _this.apiDatas = res.data.data;
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("button", { on: { click: _vm.searchData } }, [_vm._v("search data")]),
      _vm._v(" "),
      _vm._l(_vm.apiDatas, function(apiData, i) {
        return _c("div", { key: i }, [
          _c("p", [_vm._v(_vm._s(apiData.title))]),
          _vm._v(" "),
          _c("hr")
        ])
      }),
      _vm._v(" "),
      _c("button", { on: { click: _vm.pageUp } }, [_vm._v("pageUp")])
    ],
    2
  )
}
